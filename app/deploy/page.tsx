...
import { Check, Sparkles, MessageCircle, Send, Globe, Zap, Server, LifeBuoy, Shield, Lock, Scale, Clock, Terminal, ChevronRight, Loader2 } from "lucide-react";
...
export default function Deploy() {
  ...
  const models = [
    { id: "claude", name: "Claude Opus 4.5", icon: Sparkles, color: "text-orange-400" },
    { id: "gpt", name: "GPT-5.2", icon: Zap, color: "text-green-400" },
    { id: "gemini", name: "Gemini 3 Flash", icon: Globe, color: "text-blue-400" }
  ];
  ...
  const features = [
    { title: "Bank-Grade Security", description: "Every agent runs in an isolated Firecracker microVM enclave.", icon: Shield },
    { title: "Zero Maintenance", description: "We handle updates, scaling, and infrastructure patching.", icon: Clock },
    { title: "Instant Scale", description: "Deploy one agent or a swarm of thousands in seconds.", icon: Scale },
    { title: "No-Code Required", description: "No Docker. No Kubernetes. Just select your model and go.", icon: Terminal }
  ];
             ...
             <div className="w-full max-w-6xl mb-24">
                 <div className="text-center mb-16">
                     ...
                     <p className="text-muted-foreground max-w-2xl mx-auto">
                        We have optimized the infrastructure so you can focus on building intelligent behaviors, not managing servers.
                     </p>
                 </div>
                     ...
                     <div className="grid grid-cols-1 lg:grid-cols-2">
                         <div className="p-8 md:p-12 flex flex-col justify-center space-y-6">
                             ...
                             <p className="text-muted-foreground leading-relaxed">
                                 Security is not an afterthought—it is the core of our platform. Every deployed agent runs in a completely isolated environment with strict network policies.
                             </p>
