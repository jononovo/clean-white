...
import { Search, Shield, Bell, Menu, LayoutGrid, Sun, Moon, Palette, PanelLeftOpen, PanelLeftClose, Mail } from "lucide-react";
        ...
        <header className="h-16 border-b border-border bg-card/80 backdrop-blur-sm sticky top-0 z-40 px-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="flex items-center gap-2">
               <Button 
                 size="icon"
                 className="bg-[#24292e] hover:bg-[#24292e]/90 text-white shadow-sm cursor-pointer dark:border dark:border-white/10"
               ...
               <Button 
                 size="icon"
                 className="bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 shadow-sm cursor-pointer dark:bg-card dark:text-foreground dark:border-border dark:hover:bg-muted"
                 onClick={() => setAuthOpen(true)}
               >
