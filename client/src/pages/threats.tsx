...
import { Shield, ExternalLink, AlertTriangle, Search, Filter, Plus, FileText, Share2, Globe, Clock, AlertCircle } from "lucide-react";
...
export default function Threats() {
  ...
  const [threats, setThreats] = useState<ThreatAlert[]>(THREAT_ALERTS);
